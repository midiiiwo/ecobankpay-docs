...
export default function IntegrationPage() {
    ...
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <Alert>
        ...
        <AlertDescription>
          ...
          gateway checkout using the semi-direct option to collect customer
          payments from your website or mobile App.
        </AlertDescription>
      </Alert>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-4 mt-4">
          <Link
            href="/docs/integration/direct-checkout"
            className="block p-6 rounded-lg border border-border hover:border-primary hover:bg-accent transition-colors"
          >
            <h3 className="text-xl font-semibold mb-2">Direct Checkout v1.0</h3>
            <p className="text-muted-foreground">
              Use our simplified direct checkout option to quickly integrate
              payment processing into your website or app.
            </p>
          </Link>
          {/* <div className="block p-6 rounded-lg border border-border">
            <h3 className="text-xl font-semibold mb-2">Semi-Direct Option</h3>
            <p className="text-muted-foreground">
              Detailed below - more control over the payment process with
      ...
      <div className="space-y-4">
        ...
        <ol className="ml-6 list-decimal space-y-4 my-6">
          <li className="leading-7">
            ...
            <p>
              The merchant creates a payment request by sending required
              parameters (including the merchant key, invoice ID, and total
              amount) to the EcobankPay API endpoint.
            </p>
          </li>
          ...
          <li className="leading-7">
            ...
            <p>
              EcobankPay processes the request and returns a checkout URL where
          ...
          <li className="leading-7">
            <p className="font-semibold">
              Customer completes payment on EcobankPay
            </p>
            <p>
              The customer is redirected to the checkout URL where they select
              their preferred payment method (Mobile Money, Card, etc.) and
          ...
          <li className="leading-7">
            ...
            <p>
              After the payment is completed (or cancelled), the customer is
              redirected back to the merchant site using the success or
              cancelled URL provided in the initial request.
            </p>
          </li>
          ...
          <li className="leading-7">
            ...
            <p>
              EcobankPay sends a notification to the merchant&apos;s IPN URL to
              inform them about the payment status.
            </p>
          </li>
          ...
          <li className="leading-7">
            ...
            <p>
              The merchant verifies the payment status by querying the
              EcobankPay API with the invoice ID.
            </p>
          </li>
        </ol>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="leading-7">
          To initiate a payment transaction, make a POST request to the
          EcobankPay API endpoint with the required parameters.
        </p>
  ...
  "secure_hash": "calculated-hash-value"
        ...
        <p className="leading-7">
          For a complete list of request parameters and their descriptions, see
          the{" "}
          <Link
            href="/api/request"
        ...
        <div className="space-y-2">
          ...
          <p className="leading-7">
            ...
            is an HMAC SHA-256 hash of the merchant_key, invoice_id, and total
...
console.log(secureHash); // Use this value in your request`}
      ...
      <div className="space-y-4">
        ...
        <p className="leading-7">
          After sending the payment request, EcobankPay will return a response
          with a checkout URL.
        </p>
  ...
  "message": "Invoice created"
        ...
        <p className="leading-7">
          If the request is successful, redirect the customer to the URL
          provided in the response to complete the payment.
        </p>
  ...
  "error": {
    ...
    "message": "merchant_key missing or empty"
        ...
        <p className="leading-7">
          If the request fails, handle the error appropriately in your
          application.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="leading-7">
          After the customer completes the payment process, you should verify
          the payment status using the status check endpoint.
        </p>
  ...
  "as_at": "2023-08-15T14:22:45Z"
        ...
        <p className="leading-7">
          For a complete list of response parameters and their descriptions, see
          the{" "}
          <Link
            href="/api/response"
            className="text-primary underline hover:text-primary/80"
      ...
      <div className="space-y-4">
        ...
        <p className="leading-7">
          EcobankPay will send a notification to your IPN URL when a payment is
          completed or cancelled. Your application should handle these
          notifications appropriately.
        </p>

        <p className="leading-7">
          For detailed information on handling payment notifications, see the{" "}
          <Link
            href="/api/webhook"
            className="text-primary underline hover:text-primary/80"
          >
      ...
      <div className="space-y-4">
        ...
        <ul className="ml-6 list-disc space-y-2">
          <li className="leading-7">
            ...
            documentation for a complete list of parameters you can include in
          ...
          <li className="leading-7">
            ...
            returned by the EcobankPay API.
          </li>
          <li className="leading-7">
            Learn how to handle{" "}
            <Link
            ...
            to automate your payment processing workflow.
          </li>
          <li className="leading-7">
          ...
          <li className="leading-7">
            ...
            for practical examples of implementing the EcobankPay integration.
          </li>
        </ul>
      </div>
